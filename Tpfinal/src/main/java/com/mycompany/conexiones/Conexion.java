package com.mycompany.conexiones;
...
public class Conexion {
    ...
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/basededatos";
    private static final String JDBC_USR = "root";
    private static final String JDBC_PASS = "sqlserver";
